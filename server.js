...
app.get("/GetCSV", async (req, res)=>{
 ...
 for(const row of result)
 {
    ...
    {
      largeStr += result2[0].teamname + "," + result2[0].leaderfirstname + "," + result2[0].leaderlastname + "," + result2[0].membertwofirstname + "," + result2[0].membertwolastname + "," + row.totalscore + "\n";
    }
